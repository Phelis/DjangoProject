...
var _CardsList = __webpack_require__(54);
...
_reactDom2.default.render(_react2.default.createElement(_App2.default, { name: 'Taylor', age: '123' }), rootElement);
...
"use strict";
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (16:6)\n\n\u001b[0m \u001b[90m 14 | \u001b[39m    \u001b[36mreturn\u001b[39m\n \u001b[90m 15 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mbutton\u001b[39m \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 16 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mbutton\u001b[39m type\u001b[33m=\u001b[39m\u001b[32m\"button\"\u001b[39m \u001b[36mclass\u001b[39m\u001b[33m=\u001b[39m\u001b[32m\"btn btn-info\"\u001b[39m onClick\u001b[33m=\u001b[39m{() \u001b[33m=>\u001b[39m \u001b[36mthis\u001b[39m\u001b[33m.\u001b[39mhandleClick()}\u001b[33m>\u001b[39m\u001b[33mClick\u001b[39m \u001b[33mMe\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mbutton\u001b[39m\u001b[33m>\u001b[39m\u001b[33m;\u001b[39m\n \u001b[90m    | \u001b[39m      \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 17 | \u001b[39m  }\n \u001b[90m 18 | \u001b[39m}\n \u001b[90m 19 | \u001b[39m\u001b[0m\n");
...
var CardsList = function (_Component) {
    ...
    _createClass(CardsList, [{
        ...
        value: function removeCard(card) {
            ...
            if (index > -1) {
                return [].concat(_toConsumableArray(this.state.cards.slice(0, index)), _toConsumableArray(this.state.cards.slice(index + 1)));
            }
        }
    }, {
        key: 'beginRemoveCard',
        value: function beginRemoveCard(card) {
            var newCards = [].concat(_toConsumableArray(this.state.cards));
            newCards[newCards.indexOf(card)].removing = true;
            this.setState({ cards: newCards });
        }
    }, {
        key: 'moveRestUp',
        value: function moveRestUp(card, delta) {
            var initialCardIndex = this.state.cards.indexOf(card);
            var newCards = [].concat(_toConsumableArray(this.state.cards));
            newCards.forEach(function (currCard, i) {
        ...
        key: 'resetTravel',
        value: function resetTravel() {
            var newCards = this.removeCard(this.state.cards.find(function (card) {
                return card.removing;
            }));

            if (newCards) {
                newCards.forEach(function (card) {
                    return delete card.travelTo;
                });
                this.setState({ cards: newCards });
            }
        }
            ...
            return _react2.default.createElement(
                ...
                this.state.cards.map(function (card, i) {
                    return _react2.default.createElement(_Card2.default, {
                        key: card.id,
                        card: card,
                        moveRestUp: _this2.moveRestUp,
                        resetTravel: i === _this2.state.cards.length - 1 ? _this2.resetTravel : null
                        // removeCard={this.removeCard}
                        , beginRemoveCard: _this2.beginRemoveCard });
                })
            );
        }
    }]);
...
var Card = function (_Component) {
    ...
    _createClass(Card, [{
        ...
        value: function onCardClick() {
            ...
            var delta = this.cardRef.getBoundingClientRect().top - this.cardRef.getBoundingClientRect().bottom - 15;
            var card = this.props.card;

            this.props.beginRemoveCard(card);
            this.cardRef.addEventListener('transitionend', function (e) {
                if (e.propertyName === 'opacity') _this2.props.moveRestUp(_this2.props.card, delta);
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                { className: className,
                    ...
                    ref: function ref(_ref) {
                        return _this4.cardRef = _ref;
                    },
                    onClick: this.onCardClick.bind(this),
                    id: card.id },
                _react2.default.createElement(
                    'div',
                    { className: 'card-inner ripple' },
                    _react2.default.createElement(
                        'div',
                        { className: 'information' },
                        _react2.default.createElement('img', { src: card.imageSrc, className: 'card-image', alt: 'some alt' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'value' },
                            card.value
